...
export const article = {
  ...
  description:
    "I've been living in the Mediterranean city of Valencia for several years now, after having lived in the vivid city of Cologne and the more industrial city of Essen (both situated in the western part of Germany).",
}
