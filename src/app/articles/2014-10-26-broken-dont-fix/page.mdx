...
export const metadata = {
  ...
  alternates: {
    canonical:
      'https://marcelkalveram.medium.com/if-it-is-broken-why-dont-you-fix-it-7fd96791f8fa',
  },
}
...
_Originally published on [Medium](https://marcelkalveram.medium.com/if-it-is-broken-why-dont-you-fix-it-7fd96791f8fa) on October 23, 2014._
