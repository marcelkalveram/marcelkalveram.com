...
export const metadata = {
  ...
  alternates: {
    canonical:
      'https://marcelkalveram.medium.com/path-to-react-native-from-rookie-to-rockstar-4f1fd457add2',
  },
}
...
_Originally published on [Medium](https://marcelkalveram.medium.com/path-to-react-native-from-rookie-to-rockstar-4f1fd457add2) on June 29, 2016._
