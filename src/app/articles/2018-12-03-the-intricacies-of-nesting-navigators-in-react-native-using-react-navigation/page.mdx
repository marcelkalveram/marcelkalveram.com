...
export const article = {
  ...
  description:
    'This is the last post in a 4-part series about building the iOS and Android app for uncovercity using React Native. You can find the other…',
}
...
1.  [Speeding up the build of a surprise dinner app in React Native using Expo](/articles/2018-09-27-speeding-up-the-build-of-a-surprise-dinner-app-in-react-native-using-expo)
