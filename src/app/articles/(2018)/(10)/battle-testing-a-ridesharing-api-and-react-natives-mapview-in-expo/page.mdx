...
export const metadata = {
  ...
  alternates: {
    canonical:
      'https://itnext.io/battle-testing-a-ride-sharing-api-and-react-natives-mapview-in-expo-c0ce5d50cbf0',
  },
}
...
- [Speeding up the build of a surprise dinner app in React Native using Expo](/articles/speeding-up-the-build-of-a-surprise-dinner-app-in-react-native-using-expo)
- Battle testing a ridesharing API and React Native's MapView in Expo
- [Supporting multiple languages in React Native with Expo Localization](/articles/supporting-multiple-languages-in-react-native-with-expos-localization-module)
- [The intricacies of nesting navigators in React Native using react-navigation](/articles/the-intricacies-of-nesting-navigators-in-react-native-using-react-navigation)
...
_Originally published in [ITNEXT](https://itnext.io/battle-testing-a-ride-sharing-api-and-react-natives-mapview-in-expo-c0ce5d50cbf0) on October 1, 2018._
